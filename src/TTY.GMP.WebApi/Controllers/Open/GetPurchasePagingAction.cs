...
{
    public class GetPurchasePagingAction
    {
        /// <summary>
        /// 开发数据业务访问
        /// </summary>
        ...
        public GetPurchasePagingAction(IOpenDataBLL openDataBll, IGoodsBLL goodsBll, IAreaBLL areaBll, IBaseSupplierBLL baseSupplierBll)
        {
